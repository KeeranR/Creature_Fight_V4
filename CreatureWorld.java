...
public class CreatureWorld extends World
{
    ...
    //We Changed the data type of playerOneCreature And playerTwoCreature to string instead of creature
    ...
    //The instance arrays and names for playerone and two creature
    ...
    {    
        ...
        //player's starter Creatures in V4
        ...
        // TODO (81): Initialize the playerOneCreatures array to a new Creature array that stores a new Charmander object, a new Golem object, and a new Ivysaur object
        //The playerOneCreature array is initialized to a new Creature array.
         ...
         */
        //The playerTwoCreatures array is initialized to a new Creature array that stores a new Pikachu object, a new Lapras object, and a new Pidgeot object
    ...
    public void act()
    {
        ...
        //Initalize the two variables that are called playerOneLose and playerTwoLose to true
        ...
        if( playerOneMenusAdded == false )
        {
            ...
            //If playerOneCreature equals charmander
            ...
            //If playerOneCreature equals golem
            else if ( playerOneCreature.equalsIgnoreCase("Golem") )
            {
                ...
                //oneFightMenu is set to a new Fight Menu that has tackle and earthquake
                ...
                //oneSwitchMenu is set to a new Switch menu that has charmander and ivysaur as a switch option
            ...
            else
            {
                ...
                //oneFightMenu is set to a new Fight Menu that has tackle and razor leaf
                ...
                //oneSwitchMenu is set to a new Switch Menu that has charmander and golem as a switch option
        ...
        if( playerTwoMenusAdded == false )
        {
            ...
            //if playerTwoCreature is switched to Pikachu
            if ( playerTwoCreature.equalsIgnoreCase("Pikachu"))
            {
                ...
                //put twoFightMenu and twoSwitchMenu's initializations for pikachu
            ...
            //if playerTwoCreature is switched to Lapras 
            ...
            //if playerTwoCreature is switched to Lapras 
            {
                ...
                //twoFightMenu is set to a new Fight menu that has tackle and hydro pump
                ...
                //twoSwitchMenu is set to a new Switch menu that has pikachu and pidgeot as a switch
            ...
            else
            {
                ...
                //twoFightMenu is set to a new fight menu that has tackle and wing attack
                ...
                //twoSwitchMenu is set to a new Switch menu that has pikachu and Lapras as a switch

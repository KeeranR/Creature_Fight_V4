...
public class Pidgeot extends Creature
{
   /**
    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            else if ( enemyType.equalsIgnoreCase("Rock"))
            {
                 ...
                 *          and a y location of half the height of the world plus 26 pixels
                 */
                getWorld().showText( "The attack wasn't very effective", getWorld().getWidth()/2, getWorld().getHeight()/2+26 );
    ...
    public void switchCreature( int idx )
    {
        ...
        {
            JOptionPane.showInputDialog(null, "Your Character Has Fainted" );
        }
        else
        {
